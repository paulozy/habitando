...
export const metadata: Metadata = {
  ...
  description:
    "Versão para corretores e imobiliárias do Consigo comprar?: Imóvel — white-label, PDF profissional, captura de leads e cadastro de empreendimentos.",
};
    ...
    <section className="py-20 md:py-28 bg-paper">
      <div className="max-w-[1200px] mx-auto px-6 md:px-10">
        ...
        <p className="text-ink-soft text-lg max-w-2xl mb-12">
          Tudo que o simulador grátis já faz, mais o que você precisa para
          fechar venda.
        </p>
    ...
    <section className="py-20 md:py-28 bg-paper-alt/40 border-y border-border">
      <div className="max-w-[1200px] mx-auto px-6 md:px-10">
        ...
        <h2 className="font-serif text-3xl md:text-4xl leading-tight text-ink mb-3 text-center">
          Preço sob proposta — early-bird na primeira leva.
        </h2>
        <p className="text-ink-soft text-lg max-w-2xl mx-auto mb-12 text-center">
          Estamos validando os planos com os primeiros corretores. Estes são os
          intervalos que estamos considerando — quem entrar agora trava o preço.
        </p>
        ...
        <p className="text-center text-[12.5px] text-ink-muted mt-8">
          Os primeiros 20 inscritos na lista de espera ganham desconto vitalício
          de 30% em qualquer plano.
        </p>
      </div>
    </section>
  );
  ...
  return (
    <section className="py-20 md:py-28 bg-paper">
      <div className="max-w-[900px] mx-auto px-6 md:px-10">
        <div className="font-mono text-[11px] tracking-[0.18em] uppercase text-ink-muted mb-4">
          Perguntas comuns dos corretores
        </div>
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <p>
              O simulador não <em>vende por você</em> — ele tira a fricção da
          ...
          <FaqItem q="E se o cliente já usou o simulador grátis?">
            <p>
              Sem problema. Quando ele entra pela sua URL personalizada, é uma
              experiência separada — com a sua marca, seus empreendimentos
              cadastrados e captura de lead direcionada pra você.
            </p>
          </FaqItem>

          <FaqItem q="Posso cancelar quando quiser?">
            <p>
              Sim. Mensalidade sem fidelidade. Se cancelar, mantém os dados por
              30 dias para exportar. Sem letra miúda.
            </p>
          </FaqItem>

          <FaqItem q="Como funciona o desconto early-bird?">
            <p>
              Os primeiros 20 corretores/imobiliárias da lista de espera ganham{" "}
              <strong>30% off vitalício</strong> em qualquer plano. Mesmo que o
              preço suba, você mantém a tarifa de fundador para sempre.
            </p>
          </FaqItem>
        </div>
      </div>
    ...
    >
      <div className="max-w-[800px] mx-auto px-6 md:px-10 text-center">
        ...
        <p className="text-ink-soft text-lg md:text-xl mb-10 max-w-xl mx-auto">
          ...
          ajuda a moldar o produto e ganha o preço de fundador.
        </p>
    ...
    <footer className="bg-ink text-white/60 py-10 border-t border-white/10">
      <div className="max-w-[1200px] mx-auto px-6 md:px-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 text-[13px]">
        ...
        <div className="flex flex-wrap gap-6">
          ...
          <Link href="/corretores" className="text-white">
            Para corretores
          </Link>
        </div>
      </div>
